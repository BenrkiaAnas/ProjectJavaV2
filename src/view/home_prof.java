 ...
 * @author ahmed
 */
public class home_prof extends javax.swing.JFrame {

    /**
     * Creates new form home_prof
     */
    public home_prof() {
        initComponents();
        showUserData();
    ...
    public void showUserData()
    {
        ...
        Personne personne = personneDao.getPersonneById(Index.id_personne);
        System.out.println(Index.id_personne);
        
        jLabel2.setText("Bonjour "+personne.getPrenom()+" "+personne.getNom());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dashboard Professeur");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(home_prof.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
